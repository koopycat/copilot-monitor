...
| PROD-006 | The product must provide read-only reporting through CLI commands. | Users can inspect stats, cost, today, sessions, and export outputs; commands may rebuild derived session summaries before reporting, but they do not alter captured request rows. |
